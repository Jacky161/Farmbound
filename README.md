...
Farmbound is a farming simulation game developed for the Playdate console. Inspired by Stardew Valley and the Harvest Moon / Story of Seasons franchise. Farmbound was designed and developed solo over the course of less than three months, including getting accustomed to a new language (Lua) and the Playdate, a bespoke and technically constrained platform.
